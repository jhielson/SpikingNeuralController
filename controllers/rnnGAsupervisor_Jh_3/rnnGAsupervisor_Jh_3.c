...
double evaluate_genotype(Genotype genotype, int demo) {
    ...
    // Initial positions
    const double MAZE1[3] = { -0.00459921, 0, 4.1 };
    const double MAZE2[3] = { 1.03058, 0, 4.1 };  
