...
double evaluate_genotype(Genotype genotype, int demo) {
    ...
    // Initial positions
    const double MAZE1[3] = { -0.00459921, 0, 2.1 };
    const double MAZE2[3] = { 1.03058, 0, 2.1 };
...
int main(int argc, const char *argv[]) {
    ...
    emitter = wb_robot_get_device("emitter_2");
    // find and enable receiver
    receiver = wb_robot_get_device("receiver_2");
