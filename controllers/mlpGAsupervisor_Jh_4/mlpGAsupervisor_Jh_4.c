...
double evaluate_genotype(Genotype genotype, int demo) {
    ...
    // Initial positions
    const double MAZE1[3] = { 3.0, 0, 6.1 };
    const double MAZE2[3] = { 4.03058, 0, 6.1 };
